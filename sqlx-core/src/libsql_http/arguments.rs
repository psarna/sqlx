...
impl<'q> LibsqlHttpArguments<'q> {
    ...
    pub(crate) fn into_static(self) -> LibsqlHttpArguments<'static> {
        LibsqlHttpArguments {
            values: self
                .values
                .into_iter()
                .map(LibsqlHttpArgumentValue::into_static)
                .collect(),
        }
    }
}
...
impl LibsqlHttpArgumentValue<'_> {
    fn into_static(self) -> LibsqlHttpArgumentValue<'static> {
        use LibsqlHttpArgumentValue::*;
